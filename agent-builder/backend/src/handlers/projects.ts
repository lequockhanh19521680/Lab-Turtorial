...
const getProject = async (projectId: string): Promise<APIGatewayProxyResult> => {
  try {
...
const createProject = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  try {
    const userId = getUserIdFromEvent(event)
...
const updateProject = async (projectId: string, event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  try {
    const body = parseJSON(event.body || '{}')
...
const deleteProject = async (projectId: string): Promise<APIGatewayProxyResult> => {
  try {
