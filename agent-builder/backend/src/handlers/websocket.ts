...
export const onConnect = async (event: APIGatewayProxyWebsocketEventV2): Promise<APIGatewayProxyResult> => {
...
export const onDisconnect = async (event: APIGatewayProxyWebsocketEventV2): Promise<APIGatewayProxyResult> => {
...
export const onMessage = async (event: APIGatewayProxyWebsocketEventV2): Promise<APIGatewayProxyResult> => {
  ...
  try {
    ...
    switch (action) {
      ...
      case 'unsubscribe':
        ...
        console.log(`Connection ${connectionId} unsubscribed from project updates`)
        break
