 ...
 */
export const extractFeatures = (requirements) => {
    if (!requirements.features || !Array.isArray(requirements.features)) {
        return [];
    }
    return requirements.features.filter((feature) => typeof feature === 'string' && feature.trim().length > 0);
};
/**
 * Generate user stories from requirements
 */
export const generateUserStories = (requirements) => {
    if (!requirements.userStories || !Array.isArray(requirements.userStories)) {
        return [];
    }
    return requirements.userStories.filter((story) => typeof story === 'string' && story.trim().length > 0);
};
/**
...
export const validateRequirements = (requirements) => {
    ...
    return (Array.isArray(requirements.features) &&
 ...
 */
export const calculateComplexity = (requirements) => {
 ...
 */
export const estimateDevelopmentTime = (requirements) => {
