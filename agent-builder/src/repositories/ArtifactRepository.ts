...
export class ArtifactRepository {
   ...
   */
  async findByType(projectId: string, artifactType: Artifact['artifactType']): Promise<Artifact[]> {
    const result = await this.docClient.send(
      new QueryCommand({
        TableName: this.tableName,
        KeyConditionExpression: "projectId = :projectId",
   ...
   * Update artifact
   */
  async update(projectId: string, artifactId: string, updates: Partial<Artifact>): Promise<Artifact> {
